...
namespace ExpediaTest
{
	...
	public class UserTest
	{
        ...
        {
            ServiceLocator serviceLocator = new ServiceLocator();
            var flightToBook = new Flight(new DateTime(2011, 6, 11), new DateTime(2011, 6, 11), 5);
            var remainingFlight = new Flight(new DateTime(2011, 6, 11), new DateTime(2011, 6, 11), 7);
